 ...
 *
 *
 * ViewGroup :ViewGroup 中定义了一个 measureChildren()方法来去测量子视图的大小
 * <p>
 ...
 *
 * View 中的 onLayout() 方法，是个空方法，在layout()方法中被调用，TextView 及子类重写实现自己的布局
 *
 ...
 *
 * <p>
 * ViewGroup中 onLayout()方法是一个抽象方法，这就意味着所有ViewGroup的子类都必须重写这个方法
 * <p>
 * onDraw()：
 * <p>
